    ...
    return (
        <SafeAreaView>
            ...
            <View style={styles.screen}>
                ...
                <Button title='Edit Review' color='shadedPrimary' size='normal' style={styles.edit} />
                <View style={styles.contaniner}>
                    <Image
                    source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/freshlyyimagestore.appspot.com/o/UserImages%2Fgimhani.jpg?alt=media&token=febb7a12-412f-459f-a2ce-b0a0ac574a91' }}
                    style={styles.image}
                    />
                    <View style={styles.innercontaniner}>
                        ...
                        <Rating value={4} />
                        <Button title='View Review' color='shadedSecondary' size='normal'  />
                    </View>
                </View>
                <View style={styles.contaniner2}>
                    ...
                    <Button title='Following' color='filledPrimary' size='normal' style={styles.btn}/>
                </View> 
            </View>
            </ScrollView>
        </SafeAreaView>
